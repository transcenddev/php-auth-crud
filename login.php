...
<body>
  ...
  <form class="form_container" action="checklogin.php" method="POST">
  <div class="logo_container"><span class="material-icons-sharp">all_inclusive</span></div>
  <div class="title_container">
    <p class="title">Login to your Account</p>
    <span class="subtitle">Get started with my website, just create an account and enjoy the experience.</span>
  </div>
  <br>
  <div class="input_container">
    ...
    <input placeholder="name@mail.com" title="Inpit title" name="username" type="text" class="input_field" id="email_field">
  </div>
  <div class="input_container">
  ...
  <div class="text-bottom">Don't have an account? <a href="register.php" class="signup-link">Signup</a></div>
</form>
</body>
</html>
