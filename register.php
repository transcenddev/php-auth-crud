...
<!DOCTYPE html>
  ...
  <body>
    ...
    <div class="title_container">
      <p class="title">Registration Account</p>
      <span class="subtitle">Get register with my website, just create an account and enjoy the experience.</span>
    </div>
    <br>
    <div class="input_container">
      ...
      <input placeholder="Username" title="Inpit title" name="username" type="text" class="input_field" id="email_field">
    </div>
    <div class="input_container">
